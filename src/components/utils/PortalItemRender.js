        ...
        if(this._is360Photo(portalSource, portalSource.width, portalSource.height)) {
          ...
          if(this._isVideo(portalSource.source.uri)) {
            ...
            viewArray.push(<Viro3DObject
                  ...
                  position={[0,-2,-6]}
                  scale={[0.5,0.5,0.5]}
                  source={require('../../img/art_gallery/artgallery3.vrx')}
                  resources={[require('../../img/art_gallery/art_gallery_projector_diffuse.png'),
                       require('../../img/art_gallery/art_gallery_projector_specular.png'),
                       require('../../img/art_gallery/art_gallery_walls_diffuse.png'),
                       require('../../img/art_gallery/art_gallery_walls_specular.png')]}
                  type="VRX" />
              );
            ...
            viewArray.push(<Viro360Image key="background_portal_image" source={require('../../img/360_space.jpg')} />);
